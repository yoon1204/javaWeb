<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    String isuccess = request.getParameter("item_success");
	...
	try{ 
		...
		String sql ="update item_cubetbl ";
			sql += " set item_price = ?, up_percent = ? ";
			sql += " where item_name = ? "; 
		st = con.prepareStatement(sql);
		
		st.setString(1,iprice);
		st.setString(2,isuccess);
